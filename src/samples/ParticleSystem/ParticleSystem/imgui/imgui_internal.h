...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderFloatNi(const char* label, float* v, int components, float const * v_min, float const * v_max, char const * const * display_format, float const * power);
