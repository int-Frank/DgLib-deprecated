...
namespace Dg
{
  namespace R3
  {
    ...
    public:
      ...
      Ray(Vector<Real> const & origin, Vector<Real> const & direction);
      ~Ray() {}
    ...
    //--------------------------------------------------------------------------------
    template<typename Real>
    Ray<Real>::Ray() : m_origin(Vector<Real>::Origin())
      , m_direction(Vector<Real>::xAxis())
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    Ray<Real>::Ray(Vector<Real> const & a_origin, Vector<Real> const & a_direction)
    {
    ...
    Ray<Real> & Ray<Real>::operator=(Ray<Real> const & a_other)
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    void Ray<Real>::Get(Vector<Real> & a_origin, Vector<Real> & a_direction) const
    {
      a_origin = m_origin;
    ...
    bool Ray<Real>::operator!=(Ray<Real> const & a_other) const
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    void Ray<Real>::Set(Vector<Real> const & a_origin, Vector<Real> const & a_direction)
    {
      //Assign
      m_origin = a_origin;
