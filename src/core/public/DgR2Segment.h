...
namespace Dg
{
  namespace R2
  {
    ...
    public:
      ...
      Segment(Vector3<Real> const & p0, Vector3<Real> const & p1);
      ~Segment() {}
    ...
    //--------------------------------------------------------------------------------
    template<typename Real>
    Segment<Real>::Segment() : m_origin(Vector3<Real>::Origin())
      , m_direction(Vector3<Real>::xAxis())
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    Segment<Real>::Segment(Vector3<Real> const & p0, Vector3<Real> const & p1)
    {
      Set(p0, p1);
    }	//End: Segment::Segment()
    ...
    Segment<Real> & Segment<Real>::operator=(Segment<Real> const & a_other)
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    void Segment<Real>::Get(Vector3<Real> & a_p0, Vector3<Real> & a_p1) const
    {
      a_p0 = m_origin;
    ...
    bool Segment<Real>::operator!=(Segment<Real> const & a_other) const
    {
      ...
      //--------------------------------------------------------------------------------
    template<typename Real>
    void Segment<Real>::Set(Vector3<Real> const & a_p0, Vector3<Real> const & a_p1)
    {
      //Assign
      m_origin = a_p0;
