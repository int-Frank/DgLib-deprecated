...
namespace Dg
{
  ...
  //--------------------------------------------------------------------------------
  template<typename T>
  class DynamicArray<T, typename std::enable_if<std::is_pod<T>::value>::type>  : public ContainerBase
  {
  public:
  ...
  //--------------------------------------------------------------------------------
  template<>
  class DynamicArray<bool, typename std::enable_if<std::is_pod<bool>::value>::type> : public ContainerBase
  {
  public:
